...
namespace waybill
{
    public partial class Form1 : Form
    {
        ...
        {
            Driver driver = Driver.findByTabNum(textBox10.Text);
            if (driver != null)
            {
                textBox7.Text = driver.name;
                textBox17.Text = driver.cert_for.ToShortDateString();
                textBox15.Text = driver.cert_number.ToString();
                textBox16.Text = driver.cert_seria.ToString();
                textBox12.Text = driver.med.ToShortDateString();
            }
            else
            {
                this.cleanDriver();
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                Driver d1 = new Driver(textBox10.Text, textBox7.Text,
                    textBox12.Text, textBox17.Text, textBox16.Text + textBox15.Text);
